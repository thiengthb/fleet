...
- A **non-obvious** decision (architecture choice, dodging a pitfall, a trade-off) → write one entry into `<project>/docs/decisions.md` (template in `nuc-platform/05-documentation-standard.md §5`), alongside the code commit.
