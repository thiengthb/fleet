---
name: user-profile
description: "Who the user is — solo architect/operator of the MiniServer platform, evaluates agent tooling critically"
metadata:
  node_type: memory
  type: user
...
Solo architect and operator of the MiniServer platform (GitHub `thiengthb`, git `thi3n`) — owns the whole
