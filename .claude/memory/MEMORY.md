...
- [Legible proposals, plain language](legible-proposals-plain-language.md) — flag the recommended option, name the gate, explain in everyday language; **default report = 3 plain sentences (did / decide / next), detail goes in files not chat**; he won't object to jargon, he just quietly stops following; **shipping a tool ⇒ lead with the command to run it**
