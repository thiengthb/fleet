...
> digests in `platform/log/YYYY-MM-DD.md` (Phase 3). It captures "what happened around **when** / at milestone X" and
...
> convention: `platform/log/README.md`. (Its frontmatter is RAG-ready — `embedding: null` until idea-0002's pgvector build.)
