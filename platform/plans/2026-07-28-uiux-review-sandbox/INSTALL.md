...
- `platform/14-uiux-review-standard.md` — the criteria/thresholds
- `platform/07-SKILL-CANDIDATES.md` — the verdict row (what was borrowed / rejected and why)
...
cp -r platform/plans/2026-07-28-uiux-review-sandbox/.claude/skills/ui-ux-review .claude/skills/
```
