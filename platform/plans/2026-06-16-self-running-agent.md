...
related:
  [
    platform/plans/2026-06-14-autonomous-agent.md (parent — Layer C3 residue + B5 done),
    platform/plans/2026-06-14-discord-control-plane.md (B4 gate-token protocol this extends),
