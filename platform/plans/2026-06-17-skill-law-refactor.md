...
- **AC-5** — Given Phase 5 governance diffs are produced, When the user reviews them, Then no agent commit touches `CLAUDE.md`, `.claude/skills/**`, or `platform/05-*` outside the user-approved diff (autonomy contract §3).
