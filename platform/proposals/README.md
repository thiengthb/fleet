...
| `2026-07-29-idea-0018-sacrificial-record-proposal.md` + `testing.md.proposed` | `platform/standards/testing.md` | ✅ **INSTALLED 2026-07-29** (`7ca43ea`). Adds §2.6 (verify a write path on a sacrificial record, never a real one — from the 2026-07-06 sakubun FSRS corruption) + one §1 pyramid row routing model-in-the-loop seams to `/behavioural-eval` (idea-0020, folded). **+22 lines in exactly 2 places.** The drop-in was deleted after applying; the proposal record stays. |
