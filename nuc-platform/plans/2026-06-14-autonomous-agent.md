...
created: 2026-06-14
updated: 2026-06-15 # B4 provisioned + DEPLOYED — bot logs `gate-approval ON` (signing key rotated after a diagnostic leaked it; env pushed via the new /nuc-set-env skill). Pending: INVENTORY/auth-apps doc-sync + live e2e (B4b.3)
related:
  [
