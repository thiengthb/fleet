...
related:
  [
    nuc-platform/plans/2026-06-14-autonomous-agent.md (this is the design for step B4),
...
<!--
  ...
  nuc-ops-bot + nuc-monitor cloned (absent on this machine — only todo/yakudoku/nuc-platform are here).
