...
related:
  [
    nuc-platform/10-idea-queue.md (idea-0001 — the candidate this analyzes),
    nuc-platform/plans/2026-06-14-phase1-idea-queue-proposal.md (Phase 1 — the queue this rides on),
    nuc-platform/plans/2026-06-14-autonomous-agent.md (Layer C "Proposer" — Reflexion oracle, C2 backlog),
    nuc-platform/09-autonomy-contract.md (propose-don't-execute),
...
this session by formalizing the rules in `nuc-platform/10-idea-queue.md` §Rules, the derivation procedure in
