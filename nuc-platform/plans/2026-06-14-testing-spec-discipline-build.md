...
related:
  [
    nuc-platform/plans/2026-06-14-testing-spec-discipline-proposal.md (accepted RFC — design + sources + the why),
    nuc-platform/10-idea-queue.md (idea-0010 done; idea-0006 folded as the top tier),
    nuc-platform/05-documentation-standard.md (the doc-set this plugs the testing standard into),
    ...
    nuc-platform/08-SHARED-ASSETS.md (gets a consumer-driven contract-test template entry),
...
- [x] B1 — Write `nuc-platform/11-testing-standard.md`: the test pyramid + which tier for what; the crisp **"pure logic ⇒
