...
updated: 2026-06-14
related:
  - nuc-platform/plans/2026-06-14-phase1-idea-queue-proposal.md
...
## Steps
- [x] Create `nuc-platform/10-idea-queue.md` — header (rules: gate-first, RICE, 15% interest cap, WIP≤5, oracle, dedup, prune) + seeded with 8 real in-flight ideas.
