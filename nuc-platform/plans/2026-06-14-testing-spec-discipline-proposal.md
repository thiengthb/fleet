...
related:
  [
    nuc-platform/10-idea-queue.md (idea-0010 — the candidate this analyzes; the overdue exploration-floor wildcard),
    nuc-platform/10-idea-queue.md (idea-0006 — Playwright E2E, deferred; this standard positions it as the pyramid's top tier),
    ...
    nuc-platform/05-documentation-standard.md (where the spec/AC convention lands),
    nuc-platform/08-SHARED-ASSETS.md (cross-repo test templates + contract-test glue),
  ]
---
